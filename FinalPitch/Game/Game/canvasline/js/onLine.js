(function($){
	$.fn.onLine = function(options){
		...
		var linewidth=4,linestyle="white";//连线绘制--线宽，线色
		var part1, part2;
	   ...
	   function score(idAttr){
		...
		var score=0;
		for(var i=0; i<4;i++){
			if(idAttr.slice(i,i+1) ==Answer[i]){
				score=score+1;
			}
		}
	//	alert("You have got: "+score+" score");
	//	window.location.href="../crossroad.html";
		...
		$.ajax({
			...
			success:function(data){
				...
				alert("You have: "+score+" scoress");
				window.location.href="../crossroad.php";
				
				//alert("You have got: "+data+" score");
			},
			dataType:"text"
