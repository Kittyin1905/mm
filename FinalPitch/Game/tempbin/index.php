...
<html lang="en">
	...
	<body>
		...
		<main class="hide">
			...
			<div id="info">
				<h1>Drag to find more soldier.</h1>
			</div>
		</main>
	...
	function initCube(imageUrl,Name) {
		 ...
		 cube2 = initCube('img/soldier2.jpg',2);
		 cube3 = initCube('img/soldier3.jpg',3);
		 cube4 = initCube('img/soldier4.jpg',4);
		 cube5 = initCube('img/soldier5.jpg',5);
		 cube6 = initCube('img/soldier2.jpg',6);
		 cube7 = initCube('img/soldier3.jpg',7);
		 cube8 = initCube('img/soldier4.jpg',8);
		 cube9 = initCube('img/soldier3.jpg',9);
